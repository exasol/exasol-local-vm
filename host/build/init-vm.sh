...
VM_CONFIG="config/init-vm-config.json"
...
if ! ./host/lib/validate-port-config.sh; then
    echo ""
...
MANIFEST_PORTFWD=$(./host/lib/read-manifest-ports.sh || true)
...
source ./host/run/get-qemu-args.sh
